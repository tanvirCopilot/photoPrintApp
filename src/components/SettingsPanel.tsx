      ...
      {unassignedCount > 0 && (
        <div className="mt-4 pt-4 border-t border-slate-700/50">
          <button
            ...
            className="w-full py-2.5 px-4 bg-violet-500/20 hover:bg-violet-500/30 text-violet-300 rounded-xl text-sm font-medium transition-all flex items-center justify-center gap-2 ring-1 ring-violet-500/30"
          >
